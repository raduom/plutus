...
evalEmulated = \case
    ...
    BlockchainProcessPending -> do
        ...
        let
            ...
            walletIndex' = foldr AM.updateAllAddresses (_walletIndex emState0) block
            idx' = view (chainState . NC.index) emState
        ...
        put emState {
            _emulatorLog   = map ChainEvent events ++ _emulatorLog emState,
